...
#if !defined(MLD_CONFIG_NO_SIGN_API) || !defined(MLD_CONFIG_NO_VERIFY_API) ||  defined(MLD_CONFIG_REDUCE_RAM) || defined(MLD_UNIT_TEST)
#define mld_poly_pointwise_montgomery_asm  MLD_NAMESPACE(poly_pointwise_montgomery_asm)
...
#endif /* !MLD_CONFIG_NO_SIGN_API || !MLD_CONFIG_NO_VERIFY_API ||  MLD_CONFIG_REDUCE_RAM || MLD_UNIT_TEST */

#define mld_polyvecl_pointwise_acc_montgomery_l4_asm  MLD_NAMESPACE(polyvecl_pointwise_acc_montgomery_l4_asm)
...
#define mld_polyvecl_pointwise_acc_montgomery_l5_asm  MLD_NAMESPACE(polyvecl_pointwise_acc_montgomery_l5_asm)
...
#define mld_polyvecl_pointwise_acc_montgomery_l7_asm  MLD_NAMESPACE(polyvecl_pointwise_acc_montgomery_l7_asm)
